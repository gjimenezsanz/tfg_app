// lib/pages/carrusel/carruselRelax_page.dart
...
import 'package:flutter_markdown/flutter_markdown.dart'; // Para texto formateado
import 'package:url_launcher/url_launcher.dart'; // Para enlaces

class CarruselRelaxPage extends StatelessWidget {
  const CarruselRelaxPage({Key? key}) : super(key: key);
  ...
  Future<String> _buildRelaxPrompt(BuildContext context) async {
    ...
    if (local != null) {
      ...
      var prompt = '''
        ...
        You are an expert in the field of meditation and wellbeing, advise relaxation and meditation techniques to help the student in the peaks of stress or anxiety due to studies or exams.
        Activity: Relaxation
      ...
      // Añade la parte de petición de contenidos
      prompt += '''
        Please provide:
