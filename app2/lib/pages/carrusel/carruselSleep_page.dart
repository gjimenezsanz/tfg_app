...
class CarruselSleepPage extends StatelessWidget {
  const CarruselSleepPage({Key? key}) : super(key: key);

  //Construye el prompt a partir de Hive
  Future<String> _buildSleepPrompt(BuildContext context) async {
    ...
    if (local != null) {
      ...
      You are an expert in the field of sleep, advise on relaxation and rest techniques to improve sleep wellbeing and help students improve their lifestyle and relationship with the importance of getting a good night's sleep.
      Activity: Sleep Improvement
    ...
    ''';
      ...
      // Petición de contenidos específicos para sleep
      prompt += '''
        Please provide:
        - Three sleep hygiene tips
        - Two guided meditation audio or video links
        - One recommended sleep tracking app
    ...
    return '''
      ...
      Please provide:
      - Three expert-backed sleep techniques
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<String>(
          future: _buildSleepPrompt(context),
